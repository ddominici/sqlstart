...
⭐️ ANALYTICS IN THE ERA OF AI [ITA] - Andrea Benedetti (Microsoft)
...
⭐️ ESTRARRE I DATI UTILIZZANDO L'AI: AZURE OPENAI VS DOCUMENT INTELLIGENCE! [ITA] - Massimo Bonanni
...
⭐️ CALCULATE - LA REGINA DELLE FUNZIONI DAX [ITA] - Francesco Bergamaschi
...
⭐️ HOW TO SAVE THE PLAN CACHE [ITA] - Alessandro Mortola
...
⭐️ THE MICROSOFT FABRIC TOUR IN 80 COPILOT PROMPTS [ITA] - Marco Englaro

Unlock the full potential of your data
Supercharge Productivity
Let AI summarize actions for you, and optimize your time
Uplevel Skills
Be better at what you’re good at and master what you’ve yet to learn
Discover Insights
...
⭐️ COME L'AI PUÒ AIUTARE NELLA DATA GOVERNANCE[ITA] - Franco Perduca
...
⭐️ MICROSOFT FABRIC PER L'IOT (E NON SOLO) [ITA] - Marco Parenzan
...
⭐️ SQL SERVER UNIT TESTING CON TSQLT, DOCKER E GITHUB ACTIONS [ITA] - Sergio Govoni
...
⭐️ FABRIC - END TO END SCENARIO [ENG] - Luca Ferrari, Anu Singh
...
⭐️ RAG AND GENERATIVE AI FOR THE DATA PROFESSIONAL [ITA] - Emanuele Meazzo
...
⭐️ ALLSELECTED: COS'È E COME FUNZIONA [ITA] - David Bianconi
...
⭐️ DIMOSTRA LA TUA ABILITÀ E OTTIENI IL GIUSTO RICONOSCIMENTO CON LE CREDENZIALI MICROSOFT [ITA] - Marco Obinu
...
⭐️ FABRIC: I LOVE YOU, I LOVE YOU NOT [ITA] - Riccardo Perico
...
⭐️ SIMPLIFYING CHATGPT: EFFICIENT DOCUMENT QUERYING WITH AZURE OPENAI [ITA] - Luca Zavarella
...
⭐️ AZURE SQL NETWORKING SECRETS [ITA] - Dennes Torres
...
⭐️ SQL PER TIME-SERIES DATA: QUESTDB [ITA] - Riccardo Solazzi

E se ti dicessi che esiste un database open source che ti permette di fare query tramite Sql su time series e che addirittura implementa alcune funzionalità appositamente per manipolare questi tipi di dati? Ti presento QuestDB: un database super ottimizzato per time-series data che grazie ad alcune sql extensions permette diverse operazioni su questi tipi di dati. In questa sessione scopriremo prima cosa c'è sotto il cofano di QuestDB e poi vedremo alcune delle sue sql extensions imparando a giocare con i dati time-series senza dover imparare nulla che già non conosciamo: SQL

---

🕜 15:15 @ B3

⭐️ MICROSOFT FABRIC: LICENSING DEMYSTIFIED [ITA] - Francesco Milano
...
⭐️ ARCHITETTURE DATI COMPLESSE E DOVE TROVARLE [ITA] - Danilo Dominici
...
⭐️ MISURAZIONE DELLE PERFORMANCE DEI PUNTI VENDITA MEDIANTE MACHINE LEARNING, IL CASO RETAILOR [ITA] - Alessio Giorgetti, Danilo Scarponi
